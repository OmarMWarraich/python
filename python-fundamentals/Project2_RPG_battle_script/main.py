...
enemy2 = Person("Magus:" ,18200, 540, 525, 25, [], [])
...
while running:
    ...
    # If player chooses tto use magic
        elif index == 1:
            player.choose_magic()
            magic_choice = int(input("    Choose magic: ")) -1

            if magic_choice == -1:   # Go back to pevious menny
                continue
        ...
        # Choose attack
            ...
            if spell.type == "white":
                ...
                if players[target].get_hp() == 0:
                    print(players[target].name.replace("  :", "") + bcolors.ENDC)
